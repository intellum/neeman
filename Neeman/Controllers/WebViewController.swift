...
class WebViewController: UIViewController, WKNavigationDelegate, WKUIDelegate {
    ...
    func showLogin() {
        dispatch_async(dispatch_get_main_queue()) { () -> Void in
            if let loginVC = self.view.window?.rootViewController?.storyboard?.instantiateViewControllerWithIdentifier("LoginNavigationController") as? UINavigationController {
